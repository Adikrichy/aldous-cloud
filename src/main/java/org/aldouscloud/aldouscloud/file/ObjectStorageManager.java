...
public interface ObjectStorageManager {
     ...
     * @param userId ID пользователя (используется для изоляции).
     * @return Полный путь к сохранённому файлу.
     * @throws IOException Если что-то пошло не так при сохранении.
     */
    String save(MultipartFile file,String bucketName, String objectKey, Long userId) throws IOException;
}
